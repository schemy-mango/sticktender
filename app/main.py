...
You can find an example of Alembic in a FastAPI project in the templates from Project Generation - Template. 
...
@app.post("/users/{user_id}/sites/", response_model=schemas.Site)
def create_site_for_user(
        user_id: int, site: schemas.SiteCreate, db: Session = Depends(get_db)
):
